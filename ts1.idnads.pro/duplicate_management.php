...
function getDuplicateData($conn, $start_date, $end_date = null) {
    ...
    $query = "SELECT device_id, COUNT(device_id) as count, 
                     GROUP_CONCAT(DATE(timestamp)) as dates, 
...
<div class="sidebar">
    ...
    <ul>
        <li><a href="admin.php"><i class="fas fa-table"></i> Daily Data</a></li>
            ...
            <?php if (!empty($data)): ?>
                <?php foreach ($data as $row): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['domains']) ?></td>
