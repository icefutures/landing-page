...
// Validasi data
if (!isset($data['deviceId']) || !isset($data['whatsappNumber']) || !isset($data['domain'])) {
...
$domain = $data['domain']; // Ambil domain
...
if ($stmt->execute()) {
    error_log("Data berhasil disimpan: DeviceID=$device_id, WhatsAppNumber=$whatsapp_number, Domain=$domain, Timestamp=$timestamp");
