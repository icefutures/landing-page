...
<head>
    ...
    <!-- Theme CSS -->
    <link rel="stylesheet" href="/css/fx-theme.css">
</head>
<body>
    <main class="page">
        <section class="hero">
        ...
        <section class="section section-packages">
            <div class="section-header">
                <h2 class="section-title">Pilih paket terbaik untuk memulai</h2>
                <p class="section-subtitle">Modal awal fleksibel, potensi profit sesuai kebutuhan Anda.</p>
            </div>
        ...
        <section class="section section-testimonials">
            <div class="section-header">
                <h2 class="section-title">Bukti nyata dari member kami</h2>
                <p class="section-subtitle">Lihat testimoni dan hasil yang sudah dicapai.</p>
            </div>
            <div class="slideshow-container">
                <div class="mySlides">
                    <img src="https://fx.idnads.pro/images/testimonial/testi1.jpg" alt="Testimonial 1" onclick="openModal(this)">
                </div>
                <div class="mySlides">
                    <img src="https://fx.idnads.pro/images/testimonial/testi2.jpg" alt="Testimonial 2" onclick="openModal(this)">
                </div>
                <div class="mySlides">
                    <img src="https://fx.idnads.pro/images/testimonial/testi3.jpg" alt="Testimonial 3" onclick="openModal(this)">
                </div>
                <div class="mySlides">
                    <img src="https://fx.idnads.pro/images/testimonial/testi4.jpg" alt="Testimonial 4" onclick="openModal(this)">
                </div>
        ...
        <section class="section section-cta">
            <div class="cta-card">
                <h2 class="cta-title">Jangan lewatkan kesempatan emas ini! Bergabunglah sekarang dan raih kesuksesan finansial Anda!</h2>
                <button class="btn btn-primary" onclick="window.open('https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20bergabung%20sekarang!', '_blank')">
                    <i class="fab fa-whatsapp"></i> Hubungi Kami Via WhatsApp Sekarang!
                </button>
            </div>
        </section>
